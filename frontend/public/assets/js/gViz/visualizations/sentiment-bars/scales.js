...
gViz.vis.sentimentBars.scales = function () {
  "use strict";
        ...
        case 'run':
          ...
          switch (action) {
            ...
            case 'create':
              ...
              _var.xScale.domain(_var._data.paragraphs.map(function (d, i) {
                return i;
              }));

              _var.yScale = d3.scaleLinear().range([_var.height, 0]);
              _var.yScale.domain([0, d3.max(_var._data.paragraphs, function (d) {
